...
```bash
uv tool install "skull @ git+https://github.com/Kroy665/skull@v0.2.1"
# or: pipx install "skull @ git+https://github.com/Kroy665/skull@v0.2.1"
# or: pip install "skull @ git+https://github.com/Kroy665/skull@v0.2.1"
```

Swap `v0.2.1` for whatever's [latest](https://github.com/Kroy665/skull/releases/latest).
